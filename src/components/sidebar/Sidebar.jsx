...
import {
  faBorderAll,        // GridIcon
  faCalendar,          // CalenderIcon
...
const navItems = [
  ...
  {
    name: "Tables",
    icon: <FontAwesomeIcon icon={faTable} className="w-5 h-5" />,
...
const othersItems = [
  ...
  {
    icon: <FontAwesomeIcon icon={faCube} className="w-5 h-5" />,
    name: "UI Elements",
    subItems: [
  ...
  {
    icon: <FontAwesomeIcon icon={faPlug} className="w-5 h-5" />,
    name: "Authentication",
    subItems: [
...
const AppSidebar = () => {
  ...
  // Update submenu height for smooth animation
  useEffect(() => {
    if (openSubmenu !== null) {
  ...
  // Render a list of navigation items (main or others)
            ...
            <div>
              ...
              >
                {isExpanded || isHovered || isMobileOpen ? (
                  ...
                  <FontAwesomeIcon icon={faEllipsisH} className="size-6" />
                )}
              </h2>
